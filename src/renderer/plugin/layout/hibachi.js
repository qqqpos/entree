const hibachi = function (printer, order, items) {
    ...
    const layout = {
        left: [{
            ...
            number: [533, 55, 130, 34, "5"],
            text: [470, 20, 130, 34]
        }, {
            seat: 6,
            rect: [474, 8, 62, 140, 0, 1],
            number: [673, 55, 130, 34, "6"],
            text: [610, 20, 130, 34]
        }, {
            seat: 7,
            rect: [613, 8, 62, 140, 0, 1],
            number: [812, 55, 130, 34, "7"],
            text: [750, 20, 130, 34]
        }, {
            seat: 8,
            rect: [613, 70, 62, 140, 0, 1],
            number: [812, 117, 130, 34, "8"],
            text: [750, 80, 130, 34]
        }, {
            seat: 9,
            rect: [613, 131, 62, 140, 0, 1],
            number: [812, 178, 130, 34, "9"],
            text: [750, 142, 130, 34]
        }, {
            seat: 10,
            rect: [613, 193, 62, 140, 0, 1],
            number: [812, 241, 130, 34, "10"],
            text: [750, 205, 130, 34]
        }],
