...
export default {
  ...
  dialog: {
    ...
    autoLock: "Auto Lock",
    autoLockTip: "POS will lock the screen due to no action in {i} seconds",
    ...
    restoreOrder: "Do you want to restore {i} ticket?",
    restoreOrderConfirm: "This ticket is voided by {i}. ( Reason: {i} )",
