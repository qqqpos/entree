...
export default {
  ...
  dialog: {
    ...
    itemRemainUnprintBeforePayment: "You need to print all items before you can print pre payment ticket.",
    ...
    restoreTableConfirm: "Do you want to restore table status as well?",
