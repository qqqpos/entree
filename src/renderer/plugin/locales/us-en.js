export default {
  ...
  type: {
    ...
    deliveryInvoice: "Deliv. Inv.",
    dineInInvoice: "DineIn Inv.",
    hibachiInvoice: "Hibachi Inv.",
  ...
  dialog: {
    ...
    attemptFailed:
      "Recovery has failed. Please call Support for troubleshooting.",
    ...
    splitTicketItemRemain:
      "This order has {i} items are not split. Please split them and try again.",
