<template>
    <div>
        <header class="nav">
            <router-link tag="div" :to="{name:'Setting.operator.config',params:{operator}}" class="back">
        ...
        <checkbox title="setting.modify.gratuity" v-model="operator.modify" val="gratuity" :multiple="true" class="list"></checkbox>
